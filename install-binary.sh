...
# Borrowed from https://github.com/technosophos/helm-template/blob/master/install-binary.sh 
# with some modifcations

PROJECT_NAME="helm-commandeer"
PROJECT_GH="thomastaylor312/$PROJECT_NAME"

: ${HELM_PLUGIN_PATH:="$(helm home)/plugins/helm-commandeer"}
...
# installFile unpacks and installs it.
# TODO: checksum validation
installFile() {
